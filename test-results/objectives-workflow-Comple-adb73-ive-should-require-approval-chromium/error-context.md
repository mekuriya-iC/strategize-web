...
- Name: objectives-workflow.spec.ts >> Complete Objectives Workflow >> Part 4: MANAGER Creates Department Objective >> department objective should require approval
- Location: tests/e2e/objectives-workflow.spec.ts:204:9
