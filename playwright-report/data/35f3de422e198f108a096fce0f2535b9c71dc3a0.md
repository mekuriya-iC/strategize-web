...
- Name: objectives-workflow.spec.ts >> Complete Objectives Workflow >> Part 1: SUPER_ADMIN Creates Corporate Objective >> should add KPI to corporate objective with auto-approval
- Location: tests/e2e/objectives-workflow.spec.ts:89:9

# Error details

```
Test timeout of 30000ms exceeded while setting up "superAdminPage".
```
