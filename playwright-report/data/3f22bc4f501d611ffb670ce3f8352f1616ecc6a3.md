...
- Name: objectives-workflow.spec.ts >> Complete Objectives Workflow >> Part 6: Permission Checks >> MANAGER should only see employees from their department
- Location: tests/e2e/objectives-workflow.spec.ts:249:9
